  ...
  .object({
    ...
    job: z
      .object({
        ...
        geoEmbedSearch: AdminConfigJobSettingsSchema,
        nsfwDetection: AdminConfigJobSettingsSchema,
    ...
    machineLearning: z
      .object({
        ...
        geoclip: AdminConfigMachineLearningModelSchema.meta({ id: 'AdminConfigGeoClipDto' }),
        nsfwDetection: AdminConfigMachineLearningModelSchema.meta({ id: 'AdminConfigNsfwDetectionDto' }),
