  ...
  async writeExif(tags: Partial<Exif>, output: string): Promise<boolean> {
    try {
      const tagsToWrite: WriteTags = {
        ...
        GPSAltitude: tags.altitude != null ? Math.abs(tags.altitude) : undefined,
        GPSAltitudeRef: tags.altitude != null ? (tags.altitude >= 0 ? 0 : 1) : undefined,
        GPSImgDirection: tags.direction,
        GPSImgDirectionRef: tags.direction != null ? 'M' : undefined,
